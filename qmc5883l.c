                                              ...
                                              size_t write_size)
{
    ...
    if (qmc5883l->interface.bus_write_data) {
        return qmc5883l->interface.bus_write_data(qmc5883l->interface.bus_user,
                                                  write_address,
                                                  write_data,
                                                  write_size);
    }
                                             ...
                                             size_t read_size)
{
    ...
    if (qmc5883l->interface.bus_read_data) {
        return qmc5883l->interface.bus_read_data(qmc5883l->interface.bus_user,
                                                 read_address,
                                                 read_data,
                                                 read_size);
    }
...
qmc5883l_err_t qmc5883l_get_xout_reg(qmc5883l_t const* qmc5883l, qmc5883l_xout_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_XOUT_LSB, data, sizeof(data));
...
qmc5883l_err_t qmc5883l_get_yout_reg(qmc5883l_t const* qmc5883l, qmc5883l_yout_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_YOUT_LSB, data, sizeof(data));
...
qmc5883l_err_t qmc5883l_get_zout_reg(qmc5883l_t const* qmc5883l, qmc5883l_zout_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_ZOUT_LSB, data, sizeof(data));
...
qmc5883l_err_t qmc5883l_get_tout_reg(qmc5883l_t const* qmc5883l, qmc5883l_tout_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_TOUT_LSB, data, sizeof(data));
...
qmc5883l_err_t qmc5883l_get_control_1_reg(qmc5883l_t const* qmc5883l, qmc5883l_control_1_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_CONTROL_1, &data, sizeof(data));
                                          ...
                                          qmc5883l_control_1_reg_t const* reg)
{
    ...
    return qmc5883l_bus_write_data(qmc5883l, QMC5883L_REG_ADDR_CONTROL_1, &data, sizeof(data));
}
...
qmc5883l_err_t qmc5883l_get_control_2_reg(qmc5883l_t const* qmc5883l, qmc5883l_control_2_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_CONTROL_2, &data, sizeof(data));
                                          ...
                                          qmc5883l_control_2_reg_t const* reg)
{
    ...
    err |= qmc5883l_bus_write_data(qmc5883l, QMC5883L_REG_ADDR_CONTROL_2, &data, sizeof(data));
...
qmc5883l_err_t qmc5883l_get_sr_period_reg(qmc5883l_t const* qmc5883l, qmc5883l_sr_period_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_SR_PERIOD, &data, sizeof(data));
                                          ...
                                          qmc5883l_sr_period_reg_t const* reg)
{
    ...
    return qmc5883l_bus_write_data(qmc5883l, QMC5883L_REG_ADDR_SR_PERIOD, &data, sizeof(data));
}
...
qmc5883l_err_t qmc5883l_get_chip_id_reg(qmc5883l_t const* qmc5883l, qmc5883l_chip_id_reg_t* reg)
{
    ...
    qmc5883l_err_t err =
        qmc5883l_bus_read_data(qmc5883l, QMC5883L_REG_ADDR_CHIP_ID, &data, sizeof(data));
