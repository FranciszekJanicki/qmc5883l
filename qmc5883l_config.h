...
typedef struct {
  void *bus_user;
  qmc5883l_err_t (*bus_initialize)(void *);
  qmc5883l_err_t (*bus_deinitialize)(void *);
  qmc5883l_err_t (*bus_write_data)(void *, uint8_t, uint8_t const *, size_t);
  qmc5883l_err_t (*bus_read_data)(void *, uint8_t, uint8_t *, size_t);
